...
const ShopbyProducts = ({loading }) => {
  ...
  return (
    <div>
      <div className="mb-[20px] relative flex justify-end ">
        <select
          onChange={handlePerpage}
          id="countries"
          class="lg:w-[78px] focus:outline-none  appearance-none text-black   border"
        >
        ...
        <FaAngleDown className=" absolute right-1 top-1  pointer-events-none text-black" />
      </div>
      <Flex className="justify-between flex-wrap">
        {loading ? (
          <Flex className="flex-wrap justify-between">
            <div
              role="status"
              className="max-w-sm lg:w-[270px]  rounded-sm shadow-sm animate-pulse md:p-6 dark:border-gray-700"
            >
